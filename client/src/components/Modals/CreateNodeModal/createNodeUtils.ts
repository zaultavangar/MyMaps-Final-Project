  ...
  switch (type) {
    ...
    case 'image':
      ...
      newNode = {
        ...
        type: type,
        // Initialize image node with correct, updated metadata
        originalWidth: imageMetaData.normalizedWidth,
        originalHeight: imageMetaData.normalizedHeight,
        updatedWidth: imageMetaData.normalizedWidth,
        updatedHeight: imageMetaData.normalizedHeight,
      }
      break
    default:
      newNode = {
