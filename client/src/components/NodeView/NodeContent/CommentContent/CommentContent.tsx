...
import { CommentTextMenu } from './CommentTextMenu'
...
export const CommentContent = (props: ITextContentProps) => {
  ...
  const editor = useEditor({
    ...
    content: currentNode.commentContent,
    autofocus: false,
  })
  ...
  return (
    <div>
      ...
      <EditorContent style={{width:'90%', marginLeft: '20px'}} editor={editor} onPointerUp={onPointerUp} />
    </div>
  )
}
